...
def apply_pseudo_labels(
    ...
    """Filter high-confidence test predictions and append to train_df.

    Returns (augmented_df, n_added).
    """
...
def retrain_with_pseudo(
    ...
    """Fine-tune a fresh copy of sbert_base on augmented_df (B), then train classifier (A).

    Returns (pipe, sbert_finetuned).
    """
    import copy
    sbert = copy.deepcopy(sbert_base)
    finetune_sbert_supervised(
